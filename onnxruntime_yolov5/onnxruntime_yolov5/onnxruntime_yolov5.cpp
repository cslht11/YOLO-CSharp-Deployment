...
std::string labels_txt_file = "D:/A_Python/yolov5-6.1/classes.txt";
...
int main(int argc, char** argv) {
	...
	std::string onnxpath = "D:/A_Python/ultralytics-main_qrcode/runs/detect/train/weights/best.onnx";
