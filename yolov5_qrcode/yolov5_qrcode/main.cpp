#include "yolov5_qrcode.h"
#include <iostream>
#include <fstream>

std::string label_map = "D:/pythonfile/yolov5-6.1_qrcode/classes.txt";
int main(int argc, char** argv) {
	...
	detector->initConfig("D:/pythonfile/yolov5-6.1_qrcode/runs/train/exp/weights/best.onnx", 640, 640, 0.25f);
	std::vector<DetectResult> results;
	cv::Mat frame = cv::imread("D:/pythonfile/yolov5-6.1_qrcode/imgs/1.bmp");
	...
	cv::VideoCapture capture("D:/pythonfile/yolov5-6.1_qrcode/imgs/video1.mp4");
	//cv::Mat frame;
	while (true) {
